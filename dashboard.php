        ...
        $(document).ready(function() {
            ...
            $("#addRepair").click(function() {
                ...
                if (description && cost && date) {
                    ...
                    $("#repair_list").append(
                        `<tr><td>${date}</td><td>${description}</td><td>${cost.toLocaleString()}원</td></tr>`
                    );
            ...
            $("#finalizeRepair").click(function() {
                ...
                if (confirm(confirmMessage)) {
                    $.post("save_repair.php", {
                        ...
                        alert('최종 저장되었습니다.');
                        window.location.href = 'dashboard.php?car_number=' + $("#car_number").val();
                    });
                }
            });
        });
            ...
            if ($car_number) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    <table id="repair_list">
                        <tr><th>날짜</th><th>수리 내역</th><th>수리 가격</th></tr>
                    </table><br>
